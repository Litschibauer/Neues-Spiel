...
| **4 Beweisen (Plattform)** | `golden.test.ts` | **324 Golden Vectors, 10 643 Commands** über alle Regelversionen — darunter ein *handgeschriebener* Vektor, der den Kernkreislauf in genau der Reihenfolge durchläuft, um die es im Spiel geht. Der Korpus, den der Mobile-Port an Tag eins abspielt. |
