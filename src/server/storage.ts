...
export class SqliteStorage implements Storage {
  ...
  wipe(): void {
    transaction(this.db, () => {
      for (const tabelle of ['accounts', 'market_offers', 'market_settlements', 'freunde', 'hilfen', 'push_abos', 'rueckmeldungen', 'fehler', 'meta', 'dorf_projekte', 'dorf_beitraege', 'zug_fahrten', 'zug_beitraege']) {
